...
1. Anderson Zudio de Moraes, Aluno de Doutorado em Computação - IC/UFF(orientador: Luiz Satoru Ochi; Co-orientador: Igor Coelho Machado.  Assunto: Efficient Algorithms for Hybrid Vehicle-drone Routing & Scheduling Problems; Previsão de término: 12/2022.  
...
1. Marcos Souza. Aluno de Doutorado em Computação IC/UFF. Tema provisório: Problemas de Logística Inteligente e Transportes: Métodos e Aplicações. Orientador: Luiz Satoru Ochi. Previsão término: 12/2025

1. Augusto Fadel. Aluno de Doutorado em Computação IC/UFF. Tema(provisorio): Problemas de Otimização e Inteligencia Computacional. Orientadores: Luiz Satoru Ochi, co-orientador: José Andre M Brito (IBGE). Previsão término: 12/2026
...
1. Alexandre dos Santos Mello**. Aluno de Mestrado em Computação IC/UFF. Tema provisório: Problemas de Roteamento com entregas fracionárias – Aplicações da empresa Loggi. Orientadores: Luiz Satoru Ochi e Matheus Haddad (UFV). Previsão de término: 12/ 2023


1. Guilherme Haddad**, Aluno de Mestrado em Computação - IC/UFF  Orientador: Luiz Satoru Ochi; Tema: Otimização & Machine Learning na solução de Problemas de Scheduling com Frotas Híbridas: Caminhões & Drones. Previsão de término: 12/2023.
